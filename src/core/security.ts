...
const STANDARD_ALLOWED_TOOLS = [
  ...
  "mcp__memory__*", "mcp__triggers__*", "mcp__agents__*", "mcp__ask-agent__*", "mcp__usage__*", "mcp__suggest-edit__*", "mcp__self__*", "mcp__file-send__*", "mcp__transcription__*", "mcp__tasks__*", "mcp__notes__*", "mcp__notify-user__*",
];
